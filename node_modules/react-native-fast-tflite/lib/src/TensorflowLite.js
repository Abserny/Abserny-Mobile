 ...
 */
export function useTensorflowModel(source, delegate = 'default') {
    ...
    useEffect(() => {
        const load = async () => {
            try {
                ...
                setState({ model: undefined, state: 'error', error: e });
            }
        };
        load();
    }, [delegate, source]);
